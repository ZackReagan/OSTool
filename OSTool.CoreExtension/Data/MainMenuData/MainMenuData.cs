namespace OSTool.CoreExtension
{
    public class MainMenuData
    {
        ...
        public static void Execute(object type, object objtype, int selecttype, int runtype = 0)
        {
            if (type.ToString() == "Registry") { RegistryMenuData.Execute(objtype, selecttype, runtype); }
            else if (type.ToString() == "Services") { ServicesMenuData.Execute(objtype, selecttype, runtype); }
